...
def test_high_dimension_increase_after_equilibrium():
    qubo = np.array([[0. , 0.7, 0.3, 0.5, 0.4, 0.9, 0.9, 0.7, 0.9, 0.8],
       [0. , 0. , 0.7, 0.4, 0.8, 0.4, 0.8, 1. , 0.5, 0.8],
       [0. , 0. , 0. , 0.7, 0.5, 0.8, 0. , 0.8, 0.7, 1. ],
       [0. , 0. , 0. , 0. , 0.7, 0. , 0.1, 0.9, 0.2, 0.6],
       [0. , 0. , 0. , 0. , 0. , 0.7, 0.2, 0.4, 0.7, 0.4],
       [0. , 0. , 0. , 0. , 0. , 0. , 0.2, 0.9, 0.4, 0.8],
