...
from qubosolver import Instance, Solution, ClassicalConfig, SolverConfig, Solver, matrix, solvers, vectori, tensor
...
_ROUNDING_DIAGONAL = vectori.tensor([
    -2, -8, -4, 0, -10, -16, -16, -14, -14, -12, -2, -6, -8, -4, -4, -4, -4, -8,
    -2, -8, -6, -2, -4, -4, -10, -12, -2, -14, -6, -8, -8, -12, -8, -12, -6, -4,
    -2, -6, 2, 0,
])

_ROUNDING_COUPLINGS = tensor.tensor([
    (1, 2, 2), (1, 31, 2), (1, 32, 2), (3, 30, 2), (3, 32, -2), (4, 5, 2),
    (4, 25, 2), (4, 29, 2), (4, 31, 2), (5, 25, 2), (5, 27, 2), (5, 29, 2),
    (5, 30, 2), (5, 31, 2), (5, 32, 2), (6, 7, 2), (6, 8, 2), (6, 19, 2),
    (6, 22, 2), (6, 25, 2), (6, 27, 2), (6, 29, 2), (7, 31, 2), (7, 32, 2),
    (7, 33, 2), (7, 36, 2), (7, 37, 2), (8, 19, 2), (8, 22, 2), (8, 24, 2),
    (8, 25, 2), (8, 27, 2), (8, 29, -2), (8, 30, 2), (9, 11, 2), (9, 25, 2),
    (9, 27, 2), (9, 29, 2), (9, 33, 2), (10, 36, -2), (10, 37, 2), (11, 33, 2),
    (12, 34, 2), (12, 35, 2), (12, 38, 2), (13, 24, 2), (14, 16, 2), (14, 33, 2),
    (14, 34, 2), (14, 38, -2), (15, 16, -2), (15, 20, 2), (15, 24, 2),
    (15, 26, 2), (15, 28, -2), (16, 33, 2), (16, 34, 2), (16, 35, 2),
    (16, 38, -2), (16, 39, -2), (17, 20, 2), (17, 26, 2), (17, 28, 2),
    (18, 26, -2), (18, 28, 2), (19, 20, 2), (23, 24, 2), (25, 26, -2),
    (25, 27, 2), (27, 28, 2), (31, 32, 2), (34, 35, -2), (36, 37, 2),
    (37, 38, -2),
], dtype=torch.int64)
